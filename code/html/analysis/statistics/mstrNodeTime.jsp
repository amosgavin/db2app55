...
<body>
<iframe id='allItemInfoFrame' width="100%" height="800" src="http://10.25.125.14:8098/MicroStrategy/servlet/mstrWeb?Server=HPTEST14&Project=ChargeAndSaleManager&port=0&evt=2048001&src=mstrWeb.2048001&visMode=0&documentID=17BB8CE14FD1E67DA8649599B4D47ACE&currentViewMedia=8&hiddensections=header,path,dockTop,dockLeft,footer&uid=hbsale&pwd=hbsale"></iframe>
</body>
