...
<html>
<head>
<title><i18n:message key="工单流转环节查看"/></title>
...
<table width="100%" align="center" border="0" cellpadding="1" cellspacing="2">
 ...
 <tr>
    <td align="center"><span style="font-family:华文中宋; color:red; ">营销活动流转环节</span><br>
        <input type="radio" id="itemType_id" name="itemType" value="1" onclick="radio_click(this)"></td>
    <td align="center"><span style="font-family:华文中宋; color:red; ">资费流转环节</span><br>
...
<ai:contractframe id="taskDurationframe" contenttype="table" title="流转环节(单位个)" width="100%" allowcontract="false" frameclosed="false" frameclosed="false">
<ai:contractitem/>
    ...
    <ai:table
        ...
        setname="com.asiainfo.bi.web.SETTaskDurationCount"
        tablemodel="com.ai.appframe2.web.datamodel.MethodModelForService"
        implservice_name="com.asiainfo.bi.service.interfaces.IStatisticsSV"
        implservice_querymethod="getProcessNodeTaskCount(String objectType, String startTimeFrom, String startTimeTo)"
        initial="false" pagesize="100" width="100%" editable="true" 
        height="355" needrefresh="true">
        <ai:col fieldname="REGION_ID" width="120" editable="false" />
        <ai:col fieldname="NBSH" width="120" editable="false" />
           <ai:col fieldname="SCB" width="120" editable="false" />
           <ai:col fieldname="HDPZ" width="120" editable="false"/>
           <ai:col fieldname="YZPZ" width="120" editable="false"/>
           <ai:col fieldname="QRSX" width="120" editable="false"/>
           <ai:col fieldname="PASS" width="120" editable="false"/>
           <ai:col fieldname="FALSE" width="120" editable="false"/>
           <ai:col fieldname="TOTAL" width="120" editable="false"/>
    </ai:table>
</ai:contractframe>
...
function dealAllData() {
    ...
    taskDurationTab.setValue(16,"REGION_ID","平均");
    ...
    for(var j = 0; j < 6; ++j){
    	...
    	taskDurationTab.setValue(16, colNameArray[j], parseFloat(sumValue/count).toFixed(1));
    }
