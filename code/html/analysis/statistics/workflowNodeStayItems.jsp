...
//function chargeSrc(){
//	window.document.getElementById("itemInfoFrame").src = "http://10.25.125.14:8098/MicroStrategy/servlet/mstrWeb?Server=HPTEST14&Project=ChargeAndSaleManager&port=0&evt=2048001&src=mstrWeb.2048001&visMode=0&documentID=144AA0184E3A7D9325A01E8DC6085D0F&currentViewMedia=8&hiddensections=header,path,dockTop,dockLeft,footer";
//}

function initPage(){
	var url = "<%=request.getContextPath()%>/analysis/statistics/mstrNodeItems.jsp";
