...
textarea {font-size:12px; background-color: #FFFFFF; color:#000000;  border:1 solid #4682B4;}
select {font-size:12px;background-color: #FFFFFF;color:#000000;}
.input{font-size:12px;color:#000000; background-color: #FFFFFF; border-width:1px; border-style:solid; border-color:#4682B4;padding-top: 2px;padding-left: 3px;height: 20px;}
form {display: inline;}
...
/*最外层区域样式*/
.G-TableOuterDiv{background:#F0F3FA;}
...
.G-TableFoot{background:url(<%=request.getContextPath()%>/jsv2/image/grid/bottom_bg.gif);border-top:1 solid #8CB2E3;height:27px;}
/*表格头区域样式*/
.GH-Head{height:22px;color:#333333;text-align:center;border:#8CB2E3 solid;border-width:0 1 0 0;background:#F8F9FD;}
/*表格头TR样式*/
.GH-TR{} 
/*表格头TD样式*/
...
/*表格头多选单元格样式*/
.GH-S{height:22px;width:24px;color:#000000;border:#8CB2E3 solid;border-width:0 1 1 0;TABLE-LAYOUT: fixed;border-COLLAPSE: collapse;background:url(<%=request.getContextPath()%>/jsv2/image/grid/title_bg.gif);display:block;}
/*表格头的多选Checkbox样式*/
...
input.table-page{border:1px solid #8A8A8A;width:24px;height:14px;text-align:center;font-size:9pt;position:relative;top:-1px;padding-top:0;}
...
input.table-page-nocount{border:1px solid #2aa1df;width:35px;height:14px;text-align:center;font-size:9pt;position:relative;top:-1px;}
#page-first-nocount{width:16px;background:url(<%=request.getContextPath()%>/jsv2/image/grid/button_begin_nocount.gif) no-repeat left;}
#page-prev-nocount{width:16px;background:url(<%=request.getContextPath()%>/jsv2/image/grid/button_prv_nocount.gif) no-repeat left;}
#page-next-nocount{width:16px;background:url(<%=request.getContextPath()%>/jsv2/image/grid/button_next_nocount.gif) no-repeat left;}
#page-go-nocount{width:16px;background:url(<%=request.getContextPath()%>/jsv2/image/grid/button_go_nocount.gif) no-repeat left;}
...
/*整体标签样式*/
.TAB_H_ITEM_STYLE{background: url(<%=request.getContextPath()%>/jsv2/image/tabPage/item_bg.gif) repeat-x bottom; width:100%; height:24px;}
/*TITLE样式含左边的图片*/
...
/*-----------PopMenu弹出菜单相关-----------*/
.aipopmenu_backdiv{background-color: #D6E1F8; border: 1 solid #4682B4;}
...
/*-----------AIDBForm相关的CSS-----------*/
.dbform_disable_style {background-color: #E3F2F9;BORDER:1px solid #4682B4;BORDER-COLLAPSE: collapse}
.dbform_inputfield_style{BORDER:1px solid #4682B4;BORDER-COLLAPSE: collapse}
.dbform_lable_style{background-color: #99BBE8;BORDER:1px solid #4682B4;}
.dbform_password_style{BORDER:1px solid #4682B4;BORDER-COLLAPSE: collapse}
.dbform_checkbox_style{border:0}
.dbform_textarea_style{BORDER:1px solid #4682B4;BORDER-COLLAPSE: collapse}

/*-----------DBLink css-----------*/
.dbform_dblink_style{}

/*-----------DBOpenWin Css-----------*/
.dbform_dbopenwin_editor_style{BORDER:1px solid #4682B4;BORDER-COLLAPSE: collapse}
.dbform_dbopenwind_btn_style{font-size:7pt bold; background-color: #C4CCFF;BORDER:1px solid #4682B4;}

 /*-----------DBFile Css-----------*/
.dbform_dbfile_btn_style{font-size:7pt bold; background-color: #C4CCFF;BORDER:1px solid #4682B4;}
/*dblist相关*/
.dbform_listbox_input_style{BORDER:1px solid #4682B4;BORDER-COLLAPSE: collapse}
.dbform_listbox_list_style{BORDER:1px solid #4682B4;BORDER-COLLAPSE: collapse;}
.dbform_listbox_input_disable_style{background-color: #E3F2F9;BORDER:1px solid #4682B4;BORDER-COLLAPSE: collapse;}
.selectspan{height:20px;border:1px solid #D1E4EC;}
/**dbdate,dbdatetime相关的样式**/
.dbform_dbdate_span_style{font-family: "Arial";BORDER:1px solid #4682B4;BORDER-COLLAPSE: collapse}
/*dbdate输入框样式*/
.dbform_dbdate_input_style{font-family: "Arial";BORDER:1px solid #4682B4;BORDER-COLLAPSE: collapse}
/*dbdate按钮样式*/
...
/*-----------DBListBox相关的css样式-----------*/
/*下拉框正常情况下的CSS样式*/
.DBListBox_normal_style{BORDER: 1px solid #4682B4;BORDER-COLLAPSE: collapse;}
/*下拉框不可用的情况下的CSS样式*/
.DBListBox_disabled_style{background-color: #E3F2F9;BORDER: 1px solid #4682B4;BORDER-COLLAPSE: collapse;}

/*-----------AIContentFrame相关的css样式-----------*/
.AIContentFrame_head_bg{height:20px;background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/title_bg1.gif);}
.AIContentFrame_head_left{width:40px;height:20px;background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/title_left1.gif);background-repeat:no-repeat}
.AIContentFrame_head_right{width:20px;height:20px;background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/title_right1.gif);background-repeat:no-repeat}
...
.line_end{padding:0}
.t-bot-ml{}
.t-bot-mc{background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/tb-title.gif) repeat-x; padding-right:5px; height:26px; text-align:left;border:1 solid #BED6E0;border-width:0 1 0 1;}
.t-bot-mt{background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/m-l.gif) no-repeat;color:#6186B0;font-weight:bold; text-align:left;padding:7px 0 0 30px;margin-right:10px;white-space: nowrap; word-break: keep-all;width:80px;height:26px;float:left;}
.t-bot-mm{border:1 solid #BED6E0;border-width:0 1 1 1;}
.t-bot-mr{}
.t-bot-bl{}
.t-bot-bc{}
.t-bot-br{}
.t-bot-mc-right{float:left;text-align:right;white-space: nowrap; word-break: keep-all;margin:2px 0 0 2px;}
.t-bot-mc-word{float:left;color:#6186B0;width:60%;text-align:center;padding-top:3px;}
.t-bot-mc-left{float:left;color:#6186B0;text-align:left;line-height:24px;}
.t-bot-mc-button{float:right;text-align:right; white-space: nowrap; word-break: keep-all;}
.t-tool-up{width:15px;height:15px;float:right;cursor:pointer;background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/tool-up.gif) no-repeat;margin:5px 5px 0 5px;background-position:0 0px;}
.t-tool-up:hover{background-position:-15px 0px;}
.t-tool-down{width:15px;height:15px;float:right;cursor:pointer;background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/tool-down.gif) no-repeat;margin:5px 5px 0 5px;background-position:0 0px;}
...
.title01{height:24px;cursor:pointer;background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/tb-title.gif) repeat-x bottom;;text-align:center; padding-top:6px;text-decoration:none;}
.title01:hover{background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/tb-title.gif) repeat-x bottom;}
.title02{height:24px;cursor:pointer;background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/tb-title.gif) repeat-x bottom;;text-align:center; padding-top:6px;text-decoration:none;}
.title02:hover{background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/tb-title.gif) repeat-x bottom;}
.title03{height:24px;cursor:pointer;background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/tb-title.gif) repeat-x bottom;;text-align:center; padding-top:6px;text-decoration:none;}
.title03:hover{background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/tb-title.gif) repeat-x bottom;}
.title04{height:24px;cursor:pointer;background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/tb-title.gif) repeat-x bottom;;text-align:center; padding-top:6px;text-decoration:none;}
.title04:hover{background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/tb-title.gif) repeat-x bottom;}
.title05{height:24px;cursor:pointer;background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/tb-title.gif) repeat-x bottom;;text-align:center; padding-top:6px;text-decoration:none;}
.title05:hover{background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/tb-title.gif) repeat-x bottom;}
.title06{height:24px;cursor:pointer;background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/tb-title.gif) repeat-x bottom;;text-align:center; padding-top:6px;text-decoration:none;}
.title06:hover{background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/tb-title.gif) repeat-x bottom;}
.title07{height:24px;cursor:pointer;background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/tb-title.gif) repeat-x bottom;;text-align:center; padding-top:6px;text-decoration:none;}
.title07:hover{background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/tb-title.gif) repeat-x bottom;}
.title08{height:24px;cursor:pointer;background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/tb-title.gif) repeat-x bottom;;text-align:center; padding-top:6px;text-decoration:none;}
.title08:hover{background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/tb-title.gif) repeat-x bottom;}
.title09{height:24px;cursor:pointer;background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/tb-title.gif) repeat-x bottom;;text-align:center; padding-top:6px;text-decoration:none;}
.title09:hover{background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/tb-title.gif) repeat-x bottom;}
.title10{height:24px;cursor:pointer;background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/tb-title.gif) repeat-x bottom;;text-align:center; padding-top:6px;text-decoration:none;}
.title10:hover{background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/tb-title.gif) repeat-x bottom;}

.content{ height:100%;width:100%;overflow:auto;padding:0px;margin:0px;}
a.li {display:block; height:20px;_padding-top:4px;_height:16px;padding-left:15px;text-decoration: none;color:#333333;line-height:20px;}
a.li:hover {background:url(<%=request.getContextPath()%>/jsv2/image/contentframe/tab_hoverbg.gif) repeat-x;height:20px;_padding-top:4px;_height:16px;color:#666666;line-height:20px;}
