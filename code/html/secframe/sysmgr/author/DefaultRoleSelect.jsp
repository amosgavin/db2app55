  ...
  <body onload="initRole()">
    ...
    <ai:contractframe id="ctframe1" contenttype="table" title="sec.roleselect.list" i18nRes="i18n.secframe_resource" width="100%" allowcontract="false" frameclosed="false">
    	...
    	<ai:table tableid="dbTableRole"
    		...
    		<ai:col fieldname="ROLE_NAME"  visible="true" editable = "false" width="13%"/>
    		...
    		<ai:col fieldname="DOMAIN_ID"   visible="true" editable = "false" width="13%"/>
    		<ai:col fieldname="AUTHOR_TYPE"  visible="true" width="13%"/>
    		<ai:col fieldname="AUTHOR_VALID_DATE"  visible="true" width="17%"/>
    		<ai:col fieldname="AUTHOR_EXPIRE_DATE"  visible="true" width="18%"/>
  ...
  <script type="text/javascript">
	...
	function author()
	{
	    ...
	    if(selRows != null && selRows.length > 0)
	    {
	    	...
	    	// 获取操作员上岗ID
	    	var stId = window.dialogArguments;
	    	var param = "stId="+stId;
	    	var list = new Array();
	    	list.push(dbTableRole);
		    var msg = saveRowSet("<%=request.getContextPath()%>/business/com.ai.secframe.sysmgr.web.SecAuthorAction4Default?action=saveAuthor&"+param, list);
