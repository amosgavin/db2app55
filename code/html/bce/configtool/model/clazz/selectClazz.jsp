...
var dispUrl = "clazzView.jsp?filePath=";
var srcUrl = "../common/sourceView.jsp?fileType=Java&filePath=";
...
function refreshTabById(aTabItemId, curTreeSelect){
	if(aTabItemId ==0){		//显示Tab
		if(curMethodPath != curTreeSelect.value){	//保证源文件只解析一次
			curMethodPath = curTreeSelect.value;
			var frmObj = frames["main_tab" + "_" + "dispTab"];
			if(frmObj.refresh){
				frmObj.refresh(curTreeSelect.value);
			}
		}
	}
}
		...
		<td width="320" valign="top">
			<div class="area_tab">
          	<ai:dbtree_new id="dbTree" height="455" width="100%" 
			   datamodel="com.ai.bce.configtool.model.clazz.ClazzTreeModel" 
		...
		<td valign="top" align="right">
			<div class="area_tab">
				<ai:tab id="main_tab" width="100%" height="430" type="h" beforeSetTab="tabBeforeSetTab" afterSetTab="tabAfterSetTab">
					<ai:tabitem src="clazzView.jsp" id="dispTab" title="BES0000811" i18nRes="CRM" initial="true" />
				</ai:tab>
			</div>
		</td>
	</tr>
