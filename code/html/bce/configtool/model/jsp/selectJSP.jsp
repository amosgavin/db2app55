...
var dispUrl = "jspView.jsp?filePath=";
var srcUrl = "../common/sourceView.jsp?fileType=JSP&filePath=";
		...
		<td width="320" valign="top">
			<div class="area_tab">
          	<ai:dbtree_new id="dbTree" height="455" width="100%" 
			   datamodel="com.ai.bce.configtool.model.jsp.JSPTreeModel" 
		...
		<td valign="top" align="right">
			<div class="area_tab">
				<ai:tab id="main_tab" width="100%" height="430" type="h" beforeSetTab="tabBeforeSetTab" afterSetTab="tabAfterSetTab">
					<ai:tabitem src="jspView.jsp" id="dispTab" title="JS" initial="true" />
