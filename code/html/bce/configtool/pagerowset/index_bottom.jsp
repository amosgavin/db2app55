...
<%
	...
	//关联ID
	String PAGE_FRAME_PAGE_ID = HttpUtil.getAsString(request ,"PAGE_FRAME_PAGE_ID"); 
 	...
 	<ai:tab id="main_tab" height="100%" width="100%" type="H">
 		...
 		%>
 				<ai:tabitem  id="detail" 
 					src='<%="detail.jsp?PAGE_FRAME_PAGE_ID=" + PAGE_FRAME_PAGE_ID + "&ROWSET_ID=" + ROWSET_ID + "&module_id=" +module_id%>' 
 		...
 		%>
 					<ai:tabitem id="chart" 
 						src='<%="chart_frame.jsp?PAGE_FRAME_PAGE_ID="+PAGE_FRAME_PAGE_ID+ "&ROWSET_ID=" + ROWSET_ID + "&module_id=" +module_id %>' 
