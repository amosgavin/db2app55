...
<body onload="resizeTabToFullWindwo('main_tab')" onresize="resizeTabToFullWindwo('main_tab')">
 	...
 	<ai:tab id="main_tab" height="100%" width="100%" type="H">
 		...
 		%>
 				<ai:tabitem  id="detail" src='<%= "detail.jsp?pageFramePageId="+pageFramePageId+"&bceFrameId="+bceFrameId+ "&module_id=" +module_id%>' 
 		...
 		%>
 				<ai:tabitem id="chart" 
 					src='<%="chart_frame.jsp?pageFramePageId=" + pageFramePageId + "&bceFrameId="+bceFrameId+ "&module_id=" +module_id %>' 
