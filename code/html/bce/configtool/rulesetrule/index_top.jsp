...
<script type="text/javascript">
	function getSearchInfo(){  
		...
		g_TableRowSetManager.get("rulesetruleDBTable").refresh("cond=" + cond);
	}
	...
	function del(){
		var dbTable = g_TableRowSetManager.get("rulesetruleDBTable");
		...
		var rtVal = showDataDetail("RULESET_ID=&RULE_ID=");
		if(rtVal == '1'){
		}
		getSearchInfo();
	}
	...
	function getAllInfo(){
    	var condition = "";
    	g_TableRowSetManager.get("rulesetruleDBTable").refresh("cond="+condition);
	}
	...
	function dbclick(){	 
		...
		var condition = "RULESET_ID=" + rulesetid + "&RULE_ID=" + ruleid + "&RELATE_ID=" + relateId;
	...
	<body onload="clickFirstRow('rulesetruleDBTable')">
			...
			<tr>
				...
				<td><select id="search_type" style="width:200px">
							...
							<option value="RULE_ID"><%=LocaleResourceFactory.getResource("BES0000338")%></option>
			...
			<tr>
				...
				<td class="td_font"><ai:button text='<%=LocaleResourceFactory.getResource("BES0000325")%>' onclick="getSearchInfo()" i18nRes="CRM"/></td>
			</tr>
		</table>
		</ai:contractframe>
		<!--
		...
		<table ><tr height="3px"><td></td></tr></table>
				<ai:table tableid="rulesetruleDBTable"
					setname="com.ai.bce.web.BceRulesetRule" needrefresh="true"
					tablemodel="com.ai.appframe2.web.datamodel.MethodModelForService"
					implservice_name="com.ai.bce.configtool.service.interfaces.IConfRulesetRuleSV"
					implservice_querymethod="getBceRulesetRuleValues(String cond, int $STARTROWINDEX, int $ENDROWINDEX)"
					implservice_countmethod="getBceRulesetRuleValuesCount(String cond)"
					...
					<ai:col fieldname="RELATE_ID"/>
					<ai:col fieldname="RULESET_ID"/>
					<ai:col fieldname="RULE_TRIGGER_TYPE" />
					<ai:col fieldname="RULE_ID"/>
					<ai:col fieldname="OBJ_NAME"  />
					<ai:col fieldname="EVENT_NAME" />
					<ai:col fieldname="EVENT_OBJ_TYPE" width="120"/>
					<ai:col fieldname="CHILD_OBJ_NAME"  />
					<ai:col fieldname="PARAM_VALUE_LIST" width="520"/>
					<ai:col fieldname="VERIFY_TYPE" />
					<ai:col fieldname="MODULE_ID" width="50%"/>
