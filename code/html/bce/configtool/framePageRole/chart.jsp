...
<script>
<%
	long frameId = HttpUtil.getAsLong(request, "frameId");
	long pFrameId = HttpUtil.getAsLong(request, "pFrameId");
	long roleId = HttpUtil.getAsLong(request, "roleId");
	IConfTreeChartSV sv = (IConfTreeChartSV)ServiceFactory.getService(IConfTreeChartSV.class);
	out.println(sv.getBcePageRoleNodeMap(frameId,pFrameId,roleId));
%>
</script>
</body>
</html>
