...
<body onload="resizeTabToFullWindwo('main_tab')" onresize="resizeTabToFullWindwo('main_tab')">
 	...
 	<ai:tab id="main_tab" height="100%" width="100%" type="H">
 		...
 		%>
 				...
 				src='<%= "detail.jsp?roleId="+roleId+"&frameId="+frameId+"&pFrameId="+pFrameId+ "&module_id=" +module_id%>' 
 		...
 		%>
 				<ai:tabitem id="chart" 
 					src='<%="chart_frame.jsp?roleId="+ roleId +"&frameId=" +frameId+ "&pFrameId="+ pFrameId+ "&module_id=" +module_id%>' 
