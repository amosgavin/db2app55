...
<body>
		    <table width="100%">
				 <tr>
					<td width="100%">
		   				<fieldset>
		   					<legend ><%=LocaleResourceFactory.getResource("BES0000327")%></legend>
		   					<table  >
				   				<tr>
				   				 
				   					<td><input type="text" id="searchText" name="searchText">&nbsp;</td>
				   					<td align="center"><ai:button text="BES0000325" i18nRes="CRM" onclick="getSearchInfo()" style="cursor:hand"/>
									</td>
				   				</tr>	
			   				</table>
		   				</fieldset>
