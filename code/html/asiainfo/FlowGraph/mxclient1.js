...
mxCell.prototype.getOwner=function()
{
return this.owner;
};
mxCell.prototype.setOwner=function(owner)
{
this.owner=owner;
};
...
mxGraph.prototype.click=function(evt,cell)
{
	...
	if (cell!=null)
	{
		fd_9.setValue(cell.getId());
		fd_10.setValue(cell.getValue());
		fd_11.setValue(cell.getOwner());
		currentCell=cell;
	}
	//For display cell properties end
