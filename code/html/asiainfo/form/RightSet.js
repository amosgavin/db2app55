 function ShowRightSet(){
  ...
  var ds_temp = new Asiainfo.data.AsiaInfoJsonStore({
	     sql:"select MODELCODE, PARANAME,CNNAME,TYPE,DEFAULT,VAL,REMARK from MD.METAMODELCFG where modelcode='"+modelcode+"'",
...
searchWin.AddTrigfield(fd_val,"SELECT USECNNAME AS VALUES1,USERNAME as VALUES2  FROM MD.METAUSER WHERE 1=1");
