// Table 列信息Grid
Asiainfo.TableColumnGrid = function(config) {
	// 数据类型的编辑器
	// 列信息
	var defValue = {
		align : 'center',
	...
	// call父类构建器
	Asiainfo.TableColumnGrid.superclass.constructor.call(this, config);

	// 公布属性
	this.columnRecord = record;
}
Ext.extend(Asiainfo.TableColumnGrid, Ext.grid.EditorGridPanel, {
	/*
	 * 设置 初始列 数据编辑状态
	 */
