...
var renderShapes=view.renderShapes;
view.renderShapes=false;
...
view.renderShapes=renderShapes;
...
makeDraggable:function(element,graph,funct,dragElement,dx,dy,autoscroll,scalePreview,highlightDropTargets)
{
dx=(dx!=null)?dx:0;
...
mxGraphModel.prototype.nextId=-1;
...
mxCell.prototype.id=null;        ////编号
mxCell.prototype.value=null;     ////名称
mxCell.prototype.cnname=null;  ///描述
mxCell.prototype.objType=null;  ///对象类型
mxCell.prototype.remark=null;  ///描述

///程序编写中特有属性
mxCell.prototype.fn=null;        ///函数类型,在数据流程中，表达为新增，修改
mxCell.prototype.script=null;    ///对应脚本
mxCell.prototype.linkType=2;     ///对象类型
...
mxCell.prototype.getSource=function()
{
return this.source;
};
mxCell.prototype.getTarget=function()
{
return this.target;
};

mxCell.prototype.getobjType=function()
{
	
return this.objType;
};
mxCell.prototype.setobjType=function(objType)
{
this.objType=objType;
};

mxCell.prototype.getFn=function()
{
return this.fn;
};
mxCell.prototype.setFn=function(fn)
{
this.fn=fn;
};
mxCell.prototype.getScript=function()
{
return this.script;
};
mxCell.prototype.setScript=function(script)
{
this.script=script;
};
mxCell.prototype.getLinkType=function()
{
return this.linkType;
};
mxCell.prototype.setLinkType=function(linkType)
{
...
{
graph.fireMouseEvent(mxEvent.MOUSE_MOVE,new mxMouseEvent(evt,state,overlay));
});
};
...
mxGraphView.prototype.renderShapes=true;
...
state.invalid=false;
if(this.renderShapes&&cell!=this.currentRoot)
{
...
this.model.setTerminal(cells[i],target,false);
 ...
 if(this.AftAddedCell) this.AftAddedCell(cells,parent,index,source,target,absolute);
