...
mxCell.prototype.getSource=function(source)
{
return this.source;
};
...
mxCell.prototype.getTarget=function(target)
{
return this.target;
};
...
if(!true&&evtName=='mousedown'&&this.activeElement!=null)
{
...
if(true&&document.selection.type!='None'&&evtName!='mousedown')
{
try
{
