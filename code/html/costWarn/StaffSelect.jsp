	...
	<ai:contractframe id="contractframe1" contenttype="table" title="staffselect.stafflist" i18nRes="i18n.secframe_resource" width="100%" allowcontract="false" frameclosed="false">
	         <ai:contractitem/>
          	 <ai:table tableid="dbTableExistStaff"
					  ...
					  <ai:col fieldname="STAFF_ID" visible="true"/>	
  ...
  <script type="text/javascript">
	...
	function selectExistStaff()
	{
	    ...
	    if(selRows != null && selRows.length > 0)
	    {
	   		...
	   		var staffName  = dbTableExistStaff.getValue(selRows[0], "STAFF_NAME");
	   		var billId  = dbTableExistStaff.getValue(selRows[0], "BILl_ID");
	   		var bumen  = dbTableExistStaff.getValue(selRows[0], "ORGANIZE_NAME");
    		window.returnValue =staffId + "," +staffName + "," +billId + "," +bumen;
	    	window.self.close();
	    }
	}
