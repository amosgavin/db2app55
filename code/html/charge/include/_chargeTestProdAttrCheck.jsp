...
<ai:contractframe id="prodframeTest" contenttype="table" title="资费测试报告" width="100%" allowcontract="true" frameclosed="true">
 	<ai:contractitem/>
	<ai:contractframe id="prodframe_1" contenttype="table" title="资费项目" width="100%" allowcontract="true" frameclosed="false">
 	...
 	<ai:table
        ...
        <ai:col title="编号" fieldname="APPLY_ID" width="5" visible="false" />
		<ai:col title="资费ID" fieldname="CHARGE_ID" width="5" visible="false" />
