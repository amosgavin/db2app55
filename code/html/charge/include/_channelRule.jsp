...
var chargeDetailId = <%=request.getParameter("chargeDetailId")%>;

function initOper(){
	//if (chargeDetailId == null || chargeDetailId == '') return;
...
function saveRule() {
	if ("O" != channelRuleForm.getSts()){
		if (chargeDetailId != null && chargeDetailId != '' && chargeDetailId != 'null') {
	  	   channelRuleForm.setValue("DETAIL_ID",chargeDetailId);
	  	   channelRuleForm.setValue("REMARK1", 'charge');
		}
		var list = new Array();
