    ...
    <ai:dbform formid="chargeAMainframe" 
        ...
        <table width="98%" align="center" border="0" >
          <tr>
            ...
            <td><ai:dbformfield formid="chargeAMainframe" fieldname="REAMRK_3" width="150" editable="false" /></td>
           </tr> 
        </table>
        </ai:dbform>
  </ai:contractframe>
...
<ai:contractframe id="chargeDetailListframe" contenttype="table" title="已保存的资费明细信息" width="100%" allowcontract="true" frameclosed="fale">
   ...
   <ai:button id="bt_showChargeDetailinfo" text="查看资费信息"  onclick="showChargeDetail()"/></ai:contractitem>
    <ai:table
...
function init(){
	...
	if(stype=="y"){
    	...
    	_include_fromAttachFileFormRowSet().refresh("itemId=" + applyid + "&itemType=charge");
	...
	if(taskTag=="C002"||taskTag=="C013"||taskTag=="PC023"||taskTag=="C032"||taskTag=="PC001"||taskTag=="C036"
	   || "zqc0005" == taskTag || "zqc0004" == taskTag || "zqc0012" == taskTag || "C2004" == taskTag ){
