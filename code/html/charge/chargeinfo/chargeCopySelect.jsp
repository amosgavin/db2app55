...
<script language="javascript" src="<%=request.getContextPath()%>/sale/common/js/openSelect.js" type="text/javascript"></script>	
  ...
  <ai:contractframe id="chargeListTable" contenttype="table" title="资费案主要信息" width="100%" allowcontract="true" frameclosed="fale">
    <ai:contractitem>
    <ai:button id="bt_delcharge" text="删除资费案"  onclick="delChargeMain()"/>
    <ai:button id="bt_backChargeMain" text="回撤资费案"  onclick="backChargeMain()"/>
    </ai:contractitem>
<ai:table
        ...
        height="180" needrefresh="true">
        	<ai:col title="资费活动ID" fieldname="APPLY_ID" width="8%" visible=""/>
        	 <ai:col title="名称" fieldname="APPLY_NAME" width="12%" />
            <ai:col title="资费类型" fieldname="FEE_TYPE" width="10%" />
            <ai:col title="申请人" fieldname="PRINCIPLE" width="" visible="false"/>
            <ai:col title="申请人" fieldname="STAFF_NAME" width="10%" visible=""/>
            <ai:col title="部门" fieldname="ORGANIZE_NAME" width="10%" visible=""/>
            <ai:col title="工单状态" fieldname="IS_SUBMIT" width="10%" />
             <ai:col title="活动开始时间" fieldname="APPLY_TIME" width="20%" />
            <ai:col title="活动结束时间" fieldname="APPLY_END_TIME" width="20%" />
    </ai:table>
    </ai:contractframe>
