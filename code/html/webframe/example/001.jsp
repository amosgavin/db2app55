...
<ai:contractframe id="模块功能一" contenttype="table" title="模块功能一" width="100%" allowcontract="false" frameclosed="false">
 ...
 <table width="98%" align="center" border="0" cellpadding="1" cellspacing="2">
		...
		<tr>
           ...
           <td><input type="text" class="input" id="txtKeyNum" style="width:150"/></td>
           <td class="td_button"><ai:button text="确定" id="" onclick="" /></td>
		</tr>
      </table>
</ai:contractframe>

<ai:contractframe id="模块功能二" contenttype="table" title="模块功能二" width="100%" allowcontract="true" frameclosed="false">
 <ai:contractitem/>
 <table width="98%" align="center" border="0" cellpadding="1" cellspacing="2">
         <tr>
           <td class="td_font">客户名称：</td>
