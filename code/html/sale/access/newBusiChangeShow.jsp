    ...
    <ai:dbform formid="busiChangeMainForm" 
        ...
        <tr>
         ...
         <tr>
           ...
           <td><ai:dbformfield formid="busiChangeMainForm" fieldname="TEL" width="150" editable="false"/><span class="font_red">*</span></td>
         ...
         <tr><td colspan="4" align="center"><ai:button text="保存主信息" id="savem_bt" onclick="doWork('savebusiChangeMainInfo()')" /></td></tr>
       </table>
    </ai:dbform>
</ai:contractframe>
<ai:loginuser/>
...
<div id="create_wf_div"><%@include file="/sale/access/include/_busiChangeCreateWF.jsp"%></div>
...
function init(){ 
   ...
   if (state != '1' || _busiChangeFormRowSet.getValue("PRINCIPLE") != g_GetUserInfo().STAFF_ID){
