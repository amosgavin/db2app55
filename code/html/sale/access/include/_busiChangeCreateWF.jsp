...
var _templateCode = 'template.BusichangeFlow';
var _flowType = 'busiChangeCase';
var orgId = g_GetUserInfo().ORG_ID.substr(0,2);
if (orgId == 10) {
	_templateCode = 'template.ProvinceBusichangeFlow';
	_flowType = 'busiChangeCaseP';
}
...
{
	_mainId = _busiChangeFormRowSet.getValue("BUSI_ID");
    ...
    {
        alert("提交审核成功");
        if("busiChangeCase" == _flowType || "busiChangeCaseP" == _flowType){
        	//window.opener.queryChargeMain();
        	var url ="<%=request.getContextPath()%>/sale/access/newBusiChangeApply.jsp";
