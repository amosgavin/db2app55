...
<script language="javascript" src="<%=request.getContextPath()%>/jsv2/Calendar.jsp" type="text/javascript"></script>
  ...
  <body onload="">
    <ai:contractframe id="accessMainframe" contenttype="table" title="发布业务变更申请主要信息" width="100%" allowcontract="true" frameclosed="false">
    <ai:contractitem/>
...
function addAccessInfo(){
 ...
 if(""==applyName){return  alert("请输入渠道修改申请名称！");}
