...
<ai:contractframe id="tagDetailframe" contenttype="table" title="需要开发备用标签" width="100%" allowcontract="true" frameclosed="false" >
	...
	<ai:table setname="com.asiainfo.sale.tag.web.SETPromationTag"
			  ...
			  tablemodel="com.ai.appframe2.web.datamodel.MethodModelForService"
			  implservice_name="com.asiainfo.sale.weapon.service.interfaces.ISaleWeaponSV"
			  implservice_querymethod="	(String weaponId)"			  
			  operator="query">
		<table width="98%" align="center" border="0" cellpadding="1" cellspacing="1">
	        <tr>
	       		<td align = "left"><ai:col fieldname="WPID" width="200" editable="false" visible="true" /> </td>
				...
				<td align = "left"><ai:col fieldname="STATE" width="200" editable="false" visible="true"/> </td>
			</tr>
		</table>
	</ai:table>
...
function commit()
{
	...
	var condition = "&id=" + id + "&reason=" + trim(reason) + "&weaponId=" + weaponId + "&taskState=" + taskState + "&staffId" + staffId;
