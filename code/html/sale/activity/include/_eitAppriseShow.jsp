...
<ai:contractframe id="saleEitAppriseframe" contenttype="table" title="电子券营销活动申告单" width="100%" allowcontract="true" frameclosed="true">
    <ai:contractitem/>
...
function initEitApprise(mainId) {
    ...
    if (saleEitAppriseF.getValue("SALE_NAME") == "") {
    	saleEitAppriseF.refresh("&mainId=-1");
    }
    saleEitAppriseF.setEditSts('false');
    ...
    if (saleTelPayFeeApprise.getValue("ARRIVE_OF_MONEY_SMS") == '0') {
    	document.getElementById("tel_sms_id").style.display="none";
    }
    saleTelPayFeeApprise.setEditSts('false');
    //刷新手机配件定向专用电子券营销活动申告单
    var saleTelPartsApprise = g_FormRowSetManager.get("saleTelPartsAppriseForm");
    saleTelPartsApprise.refresh("&mainId=" + mainId+"&appriseType=sjpj_sgd");
    saleTelPartsApprise.setValue("TRIGGER_CONDITION","省平台发放");
    if (saleTelPartsApprise.getValue("ARRIVE_OF_MONEY_SMS") == '0') {
    	document.getElementById("telparts_aom_sms_id").style.display="none";
    	document.getElementById("telparts_aom_sms_case").style.display="none";
    }
    if (saleTelPartsApprise.getValue("OUT_OF_DATE_SMS") == '0') {
    	document.getElementById("telparts_ofd_sms_id").style.display="none";
    	document.getElementById("telparts_ofd_sms_day").style.display="none";
    	document.getElementById("telparts_ofd_sms_case").style.display="none";
    }
    saleTelPartsApprise.setEditSts('false');
}
...
function saveSaleEitApprise() {
	...
	saleEitAppriseF.refresh("&mainId=" + mainId);
}
