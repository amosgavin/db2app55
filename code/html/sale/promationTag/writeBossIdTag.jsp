...
<html>
<head>
<title><i18n:message key="填写boss id" res="i18n.secframe_resource"/></title>
...
<ai:contractframe id="tagDetailframe" contenttype="table" title="标识明细" width="100%" allowcontract="true" frameclosed="false" >
	...
	<ai:dbform setname="com.asiainfo.sale.tag.web.SETPromationTag"
		...
		<table width="98%" align="center" border="0" cellpadding="1" cellspacing="1">
	        <tr>
	        	<td style='display:none'><ai:dbformfield formid="tagDetailForm" fieldname="ID" width="150"/></td>
				...
				<td class="td_font">标签名：</td>
	           	<td><ai:dbformfield formid="tagDetailForm" fieldname="NAME" width="150" editable="false"/></td>
	         </tr><tr>
	           	<td class="td_font">金额(元)：</td>
	           	<td><ai:dbformfield formid="tagDetailForm" fieldname="CHARGE" width="150" editable="false"/></td>
	           	<td class="td_font">月数(月)：</td>
	           	<td><ai:dbformfield formid="tagDetailForm" fieldname="CYCLE" width="150" editable="false"/></td>
			</tr>
			<tr><td class="td_font">BOSS ID：</td>
	           	<td><ai:dbformfield formid="tagDetailForm" fieldname="TAG_CODE" width="200" editable="true"/></td></tr>
		</table>
	</ai:dbform>
</ai:contractframe>	
