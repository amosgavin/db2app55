...
var _templateCode = 'template.ReschangeFlow';
var _flowType = 'resChangeCase';
...
{
	_mainId = resourceChangeMainForm.getValue("RESOURCE_ID");
    ...
    {
        alert("提交审核成功");
        var url ="<%=request.getContextPath()%>/sale/resource/resourceApply.jsp";
