...
<div id="create_wf_div"><%@include file="/sale/complain/complainCreateWF.jsp"%></div>
</body>
</html>
<script type="text/javascript">
	...
	if (complainId== '' || complainId=='null' ||complainId == 'undefined') {
	  ...
	  table00.refresh("&complainId="+complainId);
		var state =_ordercomplainFormRowSet.getValue("STATE");
	   include_reflashAttachTable();
   		if (state != '1' || _ordercomplainFormRowSet.getValue("PRINCIPLE") != g_GetUserInfo().STAFF_ID){
