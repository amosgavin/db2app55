 ...
 *
 */
public class JSPTreeModel implements DBTreeNewDataModelInterface {

	private static transient Log log = LogFactory.getLog(JSPTreeModel.class);
	...
	public void init(ServletRequest req) throws Exception {		
		if (allServices == null) {
			...
			allServices = JSPHandler.getServiceMap(file);
		}
	}
	...
	public void getChildren(AIDBTreeNodeInterface parentNode, int arg1) throws Exception {
		try {
			...
			if(parentValue.equals("1")){
				ServiceModel model = JSPHandler.rootmodel;
