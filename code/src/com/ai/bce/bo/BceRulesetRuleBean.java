...
public class BceRulesetRuleBean extends DataContainer implements DataContainerInterface,IBceRulesetRuleValue{

  private static String  m_boName = "com.ai.bce.bo.BceRulesetRule";
  ...
  public BceRulesetRuleBean() throws AIException{
      super(S_TYPE);
  }
