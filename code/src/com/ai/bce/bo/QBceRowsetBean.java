...
public class QBceRowsetBean extends DataContainer implements DataContainerInterface,IQBceRowsetValue{

  private static String  m_boName = "com.ai.bce.bo.QBceRowset";
  ...
  public QBceRowsetBean() throws AIException{
      super(S_TYPE);
  }
