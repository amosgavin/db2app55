...
public class QBOBcePageRowsetBean extends DataContainer implements DataContainerInterface,IQBOBcePageRowsetValue{

  private static String  m_boName = "com.ai.bce.bo.QBOBcePageRowset";
  ...
  public QBOBcePageRowsetBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initRelateState(long value){
     this.initProperty(S_RelateState,new Long(value));
  }
  public  void setRelateState(long value){
     this.set(S_RelateState,new Long(value));
  }

  public  void setRelateState(Long value){
     this.set(S_RelateState,value);
  }
  
  public  Long  getRelateStateAsLong(){
     return (Long )this.get(S_RelateState);
  }
  
  
  public  void setRelateStateNull(){
     this.set(S_RelateState,null);
  }

  public long getRelateState(){
        return DataType.getAsLong(this.get(S_RelateState));
  
  }
  public long getRelateStateInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_RelateState));
      }
