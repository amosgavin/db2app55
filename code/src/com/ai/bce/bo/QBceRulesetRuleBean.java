...
public class QBceRulesetRuleBean extends DataContainer implements DataContainerInterface,IQBceRulesetRuleValue{

  private static String  m_boName = "com.ai.bce.bo.QBceRulesetRule";
  ...
  public QBceRulesetRuleBean() throws AIException{
      super(S_TYPE);
  }
