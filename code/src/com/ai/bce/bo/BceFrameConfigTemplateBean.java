...
public class BceFrameConfigTemplateBean extends DataContainer implements DataContainerInterface,IBceFrameConfigTemplateValue{

  private static String  m_boName = "com.ai.bce.bo.BceFrameConfigTemplate";
  ...
  public BceFrameConfigTemplateBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initSrcSystemType(long value){
     this.initProperty(S_SrcSystemType,new Long(value));
  }
  public  void setSrcSystemType(long value){
     this.set(S_SrcSystemType,new Long(value));
  }
  ...
  public long getSrcSystemType(){
        return DataType.getAsLong(this.get(S_SrcSystemType));
  
  }
  public long getSrcSystemTypeInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_SrcSystemType));
      }
  ...
  public void initIsLockOffer(long value){
     this.initProperty(S_IsLockOffer,new Long(value));
  }
  public  void setIsLockOffer(long value){
     this.set(S_IsLockOffer,new Long(value));
  }
  ...
  public long getIsLockOffer(){
        return DataType.getAsLong(this.get(S_IsLockOffer));
  
  }
  public long getIsLockOfferInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_IsLockOffer));
      }
