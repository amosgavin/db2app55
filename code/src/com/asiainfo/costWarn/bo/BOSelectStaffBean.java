...
public class BOSelectStaffBean extends DataContainer implements DataContainerInterface,IBOSelectStaffValue{

  private static String  m_boName = "com.asiainfo.costWarn.bo.BOSelectStaff";
  ...
  public BOSelectStaffBean() throws AIException{
      super(S_TYPE);
  }
