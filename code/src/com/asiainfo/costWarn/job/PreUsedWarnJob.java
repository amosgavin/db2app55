 ...
 * @author Bill Kratzer
 */
public class PreUsedWarnJob implements Job {

    private static Log _log = LogFactory.getLog(PreUsedWarnJob.class);

    /**
     * Empty constructor for job initilization
     */
    public PreUsedWarnJob() {
    }
    ...
    public void execute(JobExecutionContext context)
        ...
        try {
			((IPreUsedSourceDAO) ServiceFactory
					.getService(IPreUsedSourceDAO.class)).sendCostWarn();
		} catch (Exception e) {
			e.printStackTrace();
		}
