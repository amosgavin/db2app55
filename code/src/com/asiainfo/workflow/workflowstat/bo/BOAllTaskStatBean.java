...
public class BOAllTaskStatBean extends DataContainer implements DataContainerInterface,IBOAllTaskStatValue{

  private static String  m_boName = "com.asiainfo.workflow.workflowstat.bo.BOAllTaskStat";
  ...
  public BOAllTaskStatBean() throws AIException{
      super(S_TYPE);
  }
