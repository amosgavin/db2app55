...
public class BOSaleBatchPrestoreListBean extends DataContainer implements DataContainerInterface,IBOSaleBatchPrestoreListValue{

  private static String  m_boName = "com.asiainfo.sale.prestore.bo.BOSaleBatchPrestoreList";
  ...
  public BOSaleBatchPrestoreListBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initApplyAmount(long value){
     this.initProperty(S_ApplyAmount,new Long(value));
  }
  public  void setApplyAmount(long value){
     this.set(S_ApplyAmount,new Long(value));
  }
  ...
  public long getApplyAmount(){
        return DataType.getAsLong(this.get(S_ApplyAmount));
  
  }
  public long getApplyAmountInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_ApplyAmount));
      }
