...
public class BOResourceChangeBean extends DataContainer implements DataContainerInterface,IBOResourceChangeValue{

  private static String  m_boName = "com.asiainfo.sale.activity.bo.BOResourceChange";
  ...
  public BOResourceChangeBean() throws AIException{
      super(S_TYPE);
  }
