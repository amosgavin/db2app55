...
public class BOContractBean extends DataContainer implements DataContainerInterface,IBOContractValue{

  private static String  m_boName = "com.asiainfo.sale.activity.bo.BOContract";
  ...
  public BOContractBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initReserve2(long value){
     this.initProperty(S_Reserve2,new Long(value));
  }
  public  void setReserve2(long value){
     this.set(S_Reserve2,new Long(value));
  }
  ...
  public long getReserve2(){
        return DataType.getAsLong(this.get(S_Reserve2));
  
  }
  public long getReserve2InitialValue(){
        return DataType.getAsLong(this.getOldObj(S_Reserve2));
      }
