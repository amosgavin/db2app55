...
public class BOWFOperatorBean extends DataContainer implements DataContainerInterface,IBOWFOperatorValue{

  private static String  m_boName = "com.asiainfo.sale.common.bo.BOWFOperator";
  ...
  public BOWFOperatorBean() throws AIException{
      super(S_TYPE);
  }
