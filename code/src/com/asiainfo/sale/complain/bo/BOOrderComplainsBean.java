...
public class BOOrderComplainsBean extends DataContainer implements DataContainerInterface,IBOOrderComplainsValue{

  private static String  m_boName = "com.asiainfo.sale.complain.bo.BOOrderComplains";
  ...
  public BOOrderComplainsBean() throws AIException{
      super(S_TYPE);
  }
