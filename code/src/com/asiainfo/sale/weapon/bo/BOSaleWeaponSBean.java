...
public class BOSaleWeaponSBean extends DataContainer implements DataContainerInterface,IBOSaleWeaponSValue{

  private static String  m_boName = "com.asiainfo.sale.weapon.bo.BOSaleWeaponS";
  ...
  public final static String S_CostTypeOne = "COST_TYPE_ONE";//·ÑÓÃÒ»¼¶·ÖÀà
  public final static String S_CostTypeTwo = "COST_TYPE_TWO";//·ÑÓÃ¶þ¼¶·ÖÀà
  public final static String S_TelFeeDeductionTime = "TEL_FEE_DEDUCTION_TIME";//»°·ÑµÖ¿ÛµÄÊ±¼ä·¶Î§
  ...
  public BOSaleWeaponSBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
   //ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Òµï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
  ...
  public void initMremark(String value){
     this.initProperty(S_Mremark,value);
  }
  public  void setMremark(String value){
     this.set(S_Mremark,value);
  }
  public  void setMremarkNull(){
     this.set(S_Mremark,null);
  }

  public String getMremark(){
       return DataType.getAsString(this.get(S_Mremark));
  
  }
  public String getMremarkInitialValue(){
        return DataType.getAsString(this.getOldObj(S_Mremark));
      }
