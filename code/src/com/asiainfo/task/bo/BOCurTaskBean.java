...
public class BOCurTaskBean extends DataContainer implements DataContainerInterface,IBOCurTaskValue{

  private static String  m_boName = "com.asiainfo.task.bo.BOCurTask";
  ...
  public final static  String S_TestStaff = "TEST_STAFF";
  ...
  public final static  String S_PzStaff = "PZ_STAFF";
  ...
  public BOCurTaskBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initTestStaff(String value){
     this.initProperty(S_TestStaff,value);
  }
  public  void setTestStaff(String value){
     this.set(S_TestStaff,value);
  }
  public  void setTestStaffNull(){
     this.set(S_TestStaff,null);
  }

  public String getTestStaff(){
       return DataType.getAsString(this.get(S_TestStaff));
  
  }
  public String getTestStaffInitialValue(){
        return DataType.getAsString(this.getOldObj(S_TestStaff));
      }
  ...
  public void initPzStaff(String value){
     this.initProperty(S_PzStaff,value);
  }
  public  void setPzStaff(String value){
     this.set(S_PzStaff,value);
  }
  public  void setPzStaffNull(){
     this.set(S_PzStaff,null);
  }

  public String getPzStaff(){
       return DataType.getAsString(this.get(S_PzStaff));
  
  }
  public String getPzStaffInitialValue(){
        return DataType.getAsString(this.getOldObj(S_PzStaff));
      }
