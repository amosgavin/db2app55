...
public class BOProxyPriveBean extends DataContainer implements DataContainerInterface,IBOProxyPriveValue{

  private static String  m_boName = "com.asiainfo.task.bo.BOProxyPrive";
  ...
  public BOProxyPriveBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initParentId(int value){
     this.initProperty(S_ParentId,new Integer(value));
  }
  public  void setParentId(int value){
     this.set(S_ParentId,new Integer(value));
  }
  ...
  public int getParentId(){
        return DataType.getAsInt(this.get(S_ParentId));
  
  }
  public int getParentIdInitialValue(){
        return DataType.getAsInt(this.getOldObj(S_ParentId));
      }
