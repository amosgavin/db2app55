...
public class BOHistoryTaskBean extends DataContainer implements DataContainerInterface,IBOHistoryTaskValue{

  private static String  m_boName = "com.asiainfo.task.bo.BOHistoryTask";
  ...
  public BOHistoryTaskBean() throws AIException{
      super(S_TYPE);
  }
