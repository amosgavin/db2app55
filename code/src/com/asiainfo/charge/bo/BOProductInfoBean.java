...
public class BOProductInfoBean extends DataContainer implements DataContainerInterface,IBOProductInfoValue{

  private static String  m_boName = "com.asiainfo.charge.bo.BOProductInfo";
  ...
  public BOProductInfoBean() throws AIException{
      super(S_TYPE);
  }
 ...
 public void setObjectType(ObjectType  value) throws AIException{
  ...
  public void initPrivCost(long value){
     this.initProperty(S_PrivCost,new Long(value));
  }
  public  void setPrivCost(long value){
     this.set(S_PrivCost,new Long(value));
  }
  public  void setPrivCostNull(){
     this.set(S_PrivCost,null);
  }

  public long getPrivCost(){
        return DataType.getAsLong(this.get(S_PrivCost));
  
  }
  public long getPrivCostInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_PrivCost));
      }
  ...
  public void initIscrosscycle(long value){
     this.initProperty(S_Iscrosscycle,new Long(value));
  }
  public  void setIscrosscycle(long value){
     this.set(S_Iscrosscycle,new Long(value));
  }
  public  void setIscrosscycleNull(){
     this.set(S_Iscrosscycle,null);
  }

  public long getIscrosscycle(){
        return DataType.getAsLong(this.get(S_Iscrosscycle));
  
  }
  public long getIscrosscycleInitialValue(){
        return DataType.getAsLong(this.getOldObj(S_Iscrosscycle));
      }
